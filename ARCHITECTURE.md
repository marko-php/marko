...
The framework automatically discovers modules by scanning `vendor/`, `modules/`, and `app/` directories for `module.php` files. No manual registration required. Just drop a module in the right place and it's discovered.
