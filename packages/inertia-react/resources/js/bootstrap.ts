...
function normalizeReactPage(
  resolved: unknown,
): MarkoInertiaReactPage {
  ...
  throw new Error(
    "Resolved Inertia React pages must export a component function/object or a module with a default export.",
  );
}

function isPageLike(value: unknown): value is MarkoInertiaReactPage {
