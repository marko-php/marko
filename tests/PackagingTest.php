...
it('creates .gitattributes in all 70 package directories', function () use ($packagesRoot, $packages): void {
...
it('creates LICENSE (MIT) in all 70 package directories with copyright Devtomic LLC', function () use ($packagesRoot, $packages): void {
    expect($packages)->toHaveCount(70);
