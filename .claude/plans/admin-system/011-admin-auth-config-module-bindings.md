...
- [x] `it creates AdminAuthConfig with guard name and super admin role slug`
- [x] `it binds AdminUserRepositoryInterface to AdminUserRepository in module.php`
- [x] `it binds RoleRepositoryInterface to RoleRepository in module.php`
- [x] `it binds PermissionRepositoryInterface to PermissionRepository in module.php`
- [x] `it binds AdminUserProvider as factory with password hasher dependency in module.php`
- [x] `it creates RoleCreated, RoleUpdated, RoleDeleted events`
- [x] `it creates AdminUserCreated, AdminUserUpdated, AdminUserDeleted events`
- [x] `it creates PermissionsSynced event dispatched after registry sync`
- [x] `it has valid config/admin-auth.php with default values`
- [x] `it has module.php with all required bindings`
