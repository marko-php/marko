...
## Description
Apply the pilot pattern to `marko/authentication`. Single driver: `authentication-token`. No siblings yet; 
...
3. Add `packages/authentication/tests/KnownDriversValidationTest.php`
